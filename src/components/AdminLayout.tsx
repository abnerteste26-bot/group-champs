...
const ADMIN_LINKS = [
  ...
  { to: "/admin/campeonatos", label: "Corujões", icon: Trophy },
        ...
        {ADMIN_LINKS.map((l) => {
          ...
          return (
            <Link
              key={l.to}
              to={l.to}
              className={`flex flex-col items-center gap-0.5 text-[10px] font-medium px-1 ${isActive ? "text-sidebar-primary" : "text-muted-foreground"
                }`}
            >
